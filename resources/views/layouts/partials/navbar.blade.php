...
<body>
    <nav>
        <div class="nav-bar">
            ...
            @endauth
            @guest
            <span class="logo navLogo hide-on-small"><a href="{{ route('home.index') }}"><img src="https://res.cloudinary.com/dugfn9ryq/image/upload/v1690763506/houzgp8o3x2urwg8btvc.png" alt="logo" height="auto" width="160px"></a></span>
            @endguest
