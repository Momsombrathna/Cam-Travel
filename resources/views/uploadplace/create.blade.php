            ...
            <div class="row">
                <div class="col">
                    <div class="container">
                        <div class="drag-area">
                          <div class="icon">
                            <div id="image-container" class="p-2 text-sm" style="width: 350px">image detail</div>
                          </div>
                ...
                <div class="col formtext">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <form action="">
                        <input type="text" name="image" id="image-url" onchange="showImage(this.value)" class="form-control mt-1" placeholder="Image Link">
                        </form>
                        @if ($errors->has('image'))
                    ...
                    <div class=" mt-3">
                        ...
                        <input type="text" name="images" id="image-url" onchange="showImage(this.value)" class="form-control mt-1" placeholder="Image Link">
                    ...
                    <div class=" mt-3">
                        <label for="inputLocation">Image Link</label>
                        <input type="text" name="imagess" id="image-url" onchange="showImage(this.value)" class="form-control mt-1" placeholder="Image Link">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea type="text" name="location" class="form-control mt-1"  placeholder="Location"></textarea>
